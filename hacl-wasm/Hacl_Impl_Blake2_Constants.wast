(module
  ...
  (export "Hacl_Impl_Blake2_Constants___get_sigmaTable" (func 8))
  (export "Hacl_Impl_Blake2_Constants___get_ivTable_S" (func 9))
  (export "Hacl_Impl_Blake2_Constants___get_ivTable_B" (func 10))
