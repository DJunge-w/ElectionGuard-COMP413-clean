(module
  ...
  (type $12 (func (param i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  ...
  (import "Hacl_Chacha20" "Hacl_Chacha20_chacha20_encrypt" (func $9 (type 9)))
  ...
  (func $11
    ...
    (if
      (result i32)
      (then (local.get 13) (local.get 1) (local.get 2) (call 10))
      (else (i32.const -559_038_737))
    )
    (drop)
    (local.get 3)
    ...
    (if
      (result i32)
      (then (local.get 13) (local.get 3) (local.get 4) (call 10))
      (else (i32.const -559_038_737))
    )
    (drop)
    (local.get 16)
  ...
  (export "Hacl_Chacha20Poly1305_32_aead_encrypt" (func 12))
  (export "Hacl_Chacha20Poly1305_32_aead_decrypt" (func 13))
