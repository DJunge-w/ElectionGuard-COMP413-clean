(module
  ...
  (import "Hacl_HMAC" "Hacl_HMAC_compute_sha2_256" (func $8 (type 8)))
  (import "Hacl_HMAC" "Hacl_HMAC_compute_sha2_512" (func $9 (type 9)))
  (import "Hacl_HMAC" "Hacl_HMAC_compute_blake2s_32" (func $10 (type 10)))
  (import "Hacl_HMAC" "Hacl_HMAC_compute_blake2b_32" (func $11 (type 11)))
  ...
  (export "Hacl_HKDF_expand_sha2_256" (func 12))
  (export "Hacl_HKDF_extract_sha2_256" (func 13))
  (export "Hacl_HKDF_expand_sha2_512" (func 14))
  (export "Hacl_HKDF_extract_sha2_512" (func 15))
  (export "Hacl_HKDF_expand_blake2s_32" (func 16))
  (export "Hacl_HKDF_extract_blake2s_32" (func 17))
  (export "Hacl_HKDF_expand_blake2b_32" (func 18))
  (export "Hacl_HKDF_extract_blake2b_32" (func 19))
